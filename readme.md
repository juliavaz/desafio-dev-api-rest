...
### Desafio Técnico
  ...
  - Pré-requisitos:
    ```
    * Desenvolver os recursos em API Rest que realizam operações bancárias com a entidade contas a seguir:
    ```
    | Contas | Tipo |
    |-|-|
    | idConta | Numérico |
    ...
    ```
    * Tabela de transações realizadas na contas
    ```
    | Transacoes | Tipo |
    |-|-|
    ...
    ```
    * P.S.: Não é necessário realizar operações com a tabela pessoas, mas é necessária a criação da tabela para mapeamento da relação com a contas e enviar script de criação de pelo menos uma pessoas.
    ```
...
### Instruções
      ...
      5. Envie um e-mail à pessoas que está mantendo o contato com você durante o processo notificando a finalização do desafio para validação.
